...
本项目基于 Astro 构建，代码从 [cxro/astro-whono](https://github.com/cxro/astro-whono) fork 后改造而来。上游主题的模板文档和示例内容已移除，当前仓库按个人博客维护。
...
不再提供模板式一键部署按钮。部署时直接在 Vercel、Cloudflare Pages 或其他静态托管平台导入当前 GitHub 仓库即可。
